...
import { getAuthorById } from '@/lib/apiClient';
        ...
        const fetchAuthorData = async () => {
            ...
            try {
                if (authorId) {
                    ...
                    setAuthorWorks(authorData.books || []);
                }
            } catch (error) {
        ...
        return (
            <div className="min-h-screen bg-parchment dark:bg-dark-bg flex items-center justify-center">
                <div className="text-center">
                    ...
                    <h2 className="font-display text-2xl font-bold text-ink dark:text-parchment mb-2">Không tìm thấy tác giả</h2>
                    <button
    ...
    return (
        <div className="min-h-screen bg-parchment dark:bg-dark-bg transition-colors">
                ...
                <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mt-10 grid grid-cols-3 gap-4 max-w-md animate-fadeInUp stagger-2">
                        {[
                            ...
                            { icon: <Award size={18} />, value: totalViews >= 1000 ? `${(totalViews / 1000).toFixed(0)}k` : totalViews, label: 'Lượt đọc' },
                        ].map((stat) => (
                            <div
                                key={stat.label}
            ...
            <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <h2 className="font-display text-2xl font-bold text-ink dark:text-parchment mb-8">
                ...
                {authorWorks.length > 0 ? (
                    ...
                    <div className="text-center py-16 bg-white dark:bg-dark-card rounded-2xl">
                        <div className="text-5xl mb-4">📖</div>
                        <p className="text-ink-light/60 dark:text-gray-400 font-sans">Chưa có tác phẩm nào trong thư viện</p>
                    </div>
                )}
            </section>
            {reservedBook && (
...
export default AuthorDetailPageContent;
