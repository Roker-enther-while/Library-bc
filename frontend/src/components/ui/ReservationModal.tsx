                ...
                <div className="p-6">
                    {step === 'form' && (
                        <form onSubmit={handleSubmit}>
                            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 rounded-xl p-4 mb-5 flex gap-3">
                                ...
                                <div>
                                    <p className="text-blue-800 dark:text-blue-300 text-sm font-semibold mb-0.5">Quy trình đặt trước</p>
                            ...
                            <div className="mb-5">
                                ...
                                <textarea
                                    ...
                                    placeholder="Ví dụ: Tôi cần sách trong tuần này..."
                                    rows={3}
                                    maxLength={300}
                                    className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-dark-surface text-sm text-gray-700 dark:text-parchment placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 resize-none"
                                />
                            ...
                            <div className="grid grid-cols-3 gap-2 mb-6">
                                {[
                                    ...
                                    <div key={i} className="flex flex-col items-center gap-1 p-3 bg-gray-50 dark:bg-dark-surface rounded-xl text-center">
                                        <span className="text-lg">{s.icon}</span>
                                        <p className="text-[11px] font-medium text-gray-600 dark:text-gray-400 leading-tight">{s.label}</p>
                                    </div>
                                ))}
                            </div>
                    ...
                    {step === 'success' && (
                        <div className="text-center py-4">
                            ...
                            <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Đặt trước thành công! 🎉</h4>
                            <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed mb-6">
                                Yêu cầu của bạn đã được ghi nhận. Thư viện sẽ xem xét trong <strong>1–2 ngày làm việc</strong>.
                            </p>
                            <button onClick={onClose} className="w-full py-3 rounded-xl bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-sm font-semibold hover:bg-gray-200 transition-colors">
                                Đóng
                            </button>
                        </div>
                    )}
                    ...
                    {step === 'error' && (
                        <div className="text-center py-4">
                            ...
                            <h4 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Có lỗi xảy ra</h4>
                            <p className="text-gray-500 dark:text-gray-400 text-sm mb-6">{errorMsg}</p>
                            <div className="flex gap-3">
                                <button onClick={() => setStep('form')} className="flex-1 py-3 rounded-xl border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 text-sm font-semibold hover:bg-gray-50 transition-colors">
                                    Thử lại
                                </button>
                                <button onClick={onClose} className="flex-1 py-3 rounded-xl bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-sm font-semibold hover:bg-gray-200 transition-colors">
                                    Đóng
                                </button>
                            </div>
                        </div>
